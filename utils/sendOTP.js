...
async function sendMail(email) {
	try {
		...
		const message = {
			...
			to: email,
			subject:
				"Welcome to Robotics Club Nitte - Registration Successful!",
			html: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="email-container">
        ...
        <div class="footer">
            <p>&copy; 2023 Robotics Club Nitte. All rights reserved. | For more information, visit our <a href="boticsclubnitte.com/" [Club Website]">website</a>.</p>
